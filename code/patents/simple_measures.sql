...
-- load into  RDBMS thru a wizard or import script

-- Second: add assignee_id to eager_assignee 


select ea.organization, ea.organization_clnd, a.id
from eager_assignee ea 
left join assignee a on ea.organization = a.organization;

CREATE TABLE assignee_copy LIKE assignee; 
INSERT assignee_copy SELECT * FROM assignee;
SELECT * FROM assignee_copy; 

...
g1.a
ggsave("../../analysis/emps_x_about-gen-pages_v3.png")
...
g1.b <- ggplot(data=g1.df, aes(x=count.p.id., y=about_gen.count)) +
  ...
  theme.eager_chart_SCATTER
g1.b
ggsave("../../analysis/patents_x_about-gen-pages_v3.png")

# variables are not normally distributed 
shapiro.test(g1.df$max_emps)
...
g1.c <- ggplot(data=g1.df, aes(x=max_emps, y=about_exact.count)) +
  ...
  theme.eager_chart_SCATTER
g1.c
ggsave("../../analysis/emps_x_about-exact-pages_v3.png")
...
g1.d <- ggplot(data=g1.df, aes(x=count.p.id., y=about_exact.count)) +
  ...
  theme.eager_chart_SCATTER
g1.d
ggsave("../../analysis/patents_x_about-exact-pages_v3.png")

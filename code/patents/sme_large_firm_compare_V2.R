...
in.web_pages <- read.csv("..//..//orgs//about//about_predicted_and_labels.csv", header = TRUE, stringsAsFactors = FALSE) 
...
nrow (g1.df)
g1.a <- ggplot(data=g1.df, aes(x=employees, y=about_gen.count)) +
...
g1.a
ggsave("../../analysis/emps_x_about-gen-pages_v2.png")
...
g1.b <- ggplot(data=g1.df, aes(x=count.p.id., y=about_gen.count)) +
  ...
  theme.eager_chart_SCATTER
g1.b
ggsave("../../analysis/patents_x_about-gen-pages_v2.png")
...
cor.test(g1.df$employees, g1.df$about_gen.count, alternative="two.sided", method="kendall" )
cor.test(g1.df$count.p.id., g1.df$about_gen.count, alternative="two.sided", method="kendall" )

g1.c <- ggplot(data=g1.df, aes(x=employees, y=about_exact.count)) +
  geom_point(alpha=.4, size=4, color="#00a5ff") +
  labs(x="Employees", y="Number of\nabout pages,\nexact") +
  scale_x_continuous(labels=comma, limits=c(0,10000)) +
  scale_y_continuous(limits=c(0,12), breaks=seq(0,12,by=2)) +
  ...
  theme.eager_chart_SCATTER
g1.c
ggsave("../../analysis/emps_x_about-exact-pages_v2.png")
...
g1.d <- ggplot(data=g1.df, aes(x=count.p.id., y=about_exact.count)) +
  ...
  theme.eager_chart_SCATTER
g1.d
ggsave("../../analysis/patents_x_about-exact-pages_v2.png")

cor.test(g1.df$employees, g1.df$about_exact.count, alternative="two.sided", method="kendall" )
